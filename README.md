...
<img src="https://skillicons.dev/icons?i=python,sklearn,&theme=dark" height="30" />

```yaml
Highlights:
  - Documenting my end-to-end Machine Learning learning journey
  - Hands-on experimentation to build strong ML foundations
  - Personal reference and growing public portfolio for ML studies
``` 
...
Features:
  ...
  - Pytest test suite & Docker support
```
...
<img src="https://skillicons.dev/icons?i=java&theme=dark" height="30" />
...
Case Studies:
  - Job Scheduling (GA)
  - Automatic Window Blind Control (Fuzzy Logic)
```
